...
import { IObservationMatrix, IndepenceTests, IJob } from '../../types';
import {
  getObservationMatrices,
  createExperiment,
} from '../../actions/apiRequests';

export interface IPropsJobListModal extends FormComponentProps {
  visible: boolean;
  onClose: () => void;
  job: undefined | IJob;
}

class JobListModal extends React.Component<
  IPropsJobListModal
  > {
  public mounted = false;

  constructor(props: IPropsJobListModal) {
    super(props);
